...
var ThemeContext2 = React21.createContext(null);
if (true) {
...
var SvgIcon = React31.forwardRef(function SvgIcon2(inProps, ref) {
  ...
  const hasSvgAsChild = React31.isValidElement(children) && children.type === "svg";
  const ownerState = _extends({}, props, {
    color: color2,
    component,
    fontSize: fontSize2,
...
function createSvgIcon(path, displayName) {
  ...
  return React32.memo(React32.forwardRef(Component));
}
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-HWROTKFM.js.map
